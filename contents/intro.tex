...
Li\cite{li2021embedding}等人分析了大量的手机应用及其所使用的第三方库，本文从此数据集中选取了10款App作为实验的App数据集，并从这些App所包含的库中选择9个作为标准库数据集，具体包含情况如表\ref{tab:include}所示。
...
%    \multicolumn{2}{c}{Item} \\ \cmidrule(r){1-2}
	...
	Google Ads & 1 & 1 & 1 & 1 & 0 & 1 & 1 & 0 & 0 &2\\
	Apache Http & 0.377 & 0.446 & \textbf{0.852} & 0.397 & 0.446 & 0.463 \\
	happy-bubble & 0.529 & 0.486 & 0.486 & \textbf{0.929} & 0.500 & 0.486 \\
	okhttp & 0.388 & 0.444 & 0.442 & 0.379 & 0.426 & \textbf{0.808}\\
	okio & 0.400 & \textbf{0.842} & 0.527 & 0.420 & 0.439 & 0.473\\
	opensdk & 0.414 & 0.456 & 0.491 & 0.435 & \textbf{0.842} & 0.455\\
