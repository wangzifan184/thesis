...
\sjtusetup{
  ...
  info = {%
    ...
    % 标题
    %
    title           = {混淆的安卓应用第三方库及版本检测技术},
    title*          = {Third-Party Library and Version Detection in Obfuscated Android Application},
    %
    % 标题页标题
    %   可使用“\\”命令手动控制换行
    %
    ...
    % 关键词
    %
    keywords        = {软件供应链，抗混淆，两级特征，第三方库检测},
    keywords*       = {software supply chain, anti-obfuscation, two-level features, third-party library detection},
    %
    % 姓名
    %
    author          = {王梓帆},
